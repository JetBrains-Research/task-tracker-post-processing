...
file_name_from_path_data_dict = {PATHS_TEST_DATA.PATHS: [path_with_trailing_slash, path_with_leading_slash, path_with_both_slashes, path_without_slash],
...
file_name_from_file_name_data_dict = {PATHS_TEST_DATA.PATHS: [file_name_with_trailing_slash, file_name_with_leading_slash, file_name_with_both_slashes, file_name_without_slash],
                                      PATHS_TEST_DATA.FILE_NAME: real_file_name}


def test_paths_data(self, paths_data_dict: PathsDataDict) -> None:
    for path in paths_data_dict[PATHS_TEST_DATA.PATHS]:
        ...
        self.assertTrue(file_name == paths_data_dict[PATHS_TEST_DATA.FILE_NAME][EXTENSION.WITHOUT])
        ...
        self.assertTrue(file_name == paths_data_dict[PATHS_TEST_DATA.FILE_NAME][EXTENSION.WITH])


class TestGettingFileNameFromPath(LoggedTest):

    def test_path(self) -> None:
        test_paths_data(self, file_name_from_path_data_dict)

    def test_file_name(self) -> None:
        test_paths_data(self, file_name_from_file_name_data_dict)
