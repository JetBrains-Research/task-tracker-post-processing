...
class TestCanonicalizationTool(unittest.TestCase):
    ...
    def test_student_code_pies(self) -> None:
        run_test(self, CANONIZATION_TESTS_TYPES.STUDENT_CODE, get_canonicalized_code, TASK.PIES.value)

    def test_student_code_max_3(self) -> None:
        run_test(self, CANONIZATION_TESTS_TYPES.STUDENT_CODE, get_canonicalized_code, TASK.MAX_3.value)

    def test_student_code_is_zero(self) -> None:
        run_test(self, CANONIZATION_TESTS_TYPES.STUDENT_CODE, get_canonicalized_code, TASK.ZERO.value)

    def test_student_code_max_digit(self) -> None:
        run_test(self, CANONIZATION_TESTS_TYPES.STUDENT_CODE, get_canonicalized_code, TASK.MAX_DIGIT.value)

    def test_student_code_election(self) -> None:
        run_test(self, CANONIZATION_TESTS_TYPES.STUDENT_CODE, get_canonicalized_code, TASK.ELECTION.value)

    def test_student_code_brackets(self) -> None:
        run_test(self, CANONIZATION_TESTS_TYPES.STUDENT_CODE, get_canonicalized_code, TASK.BRACKETS.value)
