...
from src.main.processing.merging_tt_with_ati import __separate_ati_and_tt_files
...
TEST_DATA_FOLDER = os.path.join(consts.TEST_DATA_PATH, 'processing/preprocessing')
