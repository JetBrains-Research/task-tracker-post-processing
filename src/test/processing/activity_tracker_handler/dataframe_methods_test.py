...
ath_test_folder = os.path.join(consts.TEST_DATA_PATH, 'processing/activity_tracker_handler')
...
def get_data_for_merging_test_1() -> Tuple[pd.DataFrame, pd.DataFrame]:
    ...
    ct_df = ath.merge_task_tracker_and_activity_tracker_data(ct_df, ati_df)
