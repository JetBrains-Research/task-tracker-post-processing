...
def __get_statistics_from_file(path: str, column: plot_consts.STATISTIC_KEY, default_value: consts.DEFAULT_VALUES,
                               to_union_rare=False):
...
def __get_labels_for_plots(column: plot_consts.STATISTIC_KEY):
    return {
...
def __get_title_for_plots(column: plot_consts.STATISTIC_KEY):
    return get_readable_key(str(column)) + ' distribution'


def __get_default_value_for_plots(column: plot_consts.STATISTIC_KEY):
    if column == plot_consts.STATISTIC_KEY.AGE.value:
        return consts.DEFAULT_VALUES.AGE.value
    if column == plot_consts.STATISTIC_KEY.EXPERIENCE.value:
        return consts.DEFAULT_VALUES.EXPERIENCE.value
    return None


def __get_statistics_info_for_plots(column: plot_consts.STATISTIC_KEY):
    return {
...
def __plot_pie_chart(statistics_df: pd.DataFrame, title: str, path: str, column: plot_consts.STATISTIC_KEY,
                     labels: dict, plot_name='result_plot',
                     format=plot_consts.OUTPUT_FORMAT.HTML.value, auto_open=False):
...
def __plot_bar_chart(statistics_df: pd.DataFrame, column: plot_consts.STATISTIC_KEY,
                     title: str, labels: dict,
                     path: str, plot_name='result_plot', format=plot_consts.OUTPUT_FORMAT.HTML.value,
...
def plot_profile_statistics(file: str, column: plot_consts.STATISTIC_KEY, plot_type: plot_consts.PLOT_TYPES,
                            to_union_rare=False, format=plot_consts.OUTPUT_FORMAT.HTML.value, auto_open=False,
