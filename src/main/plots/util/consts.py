...
from src.main.util.consts import TASK, TASK_STATUS, DEFAULT_VALUE, TASK_TRACKER_COLUMN, RESOURCES_PATH
...
class STATISTICS_KEY(Enum):
    AGE = TASK_TRACKER_COLUMN.AGE.value
    EXPERIENCE = TASK_TRACKER_COLUMN.EXPERIENCE.value
    EXPERIENCE_YEARS = TASK_TRACKER_COLUMN.EXPERIENCE_YEARS.value
    EXPERIENCE_MONTHS = TASK_TRACKER_COLUMN.EXPERIENCE_MONTHS.value
    ...
    def get_default(self) -> DEFAULT_VALUE:
        ...
        elif self == STATISTICS_KEY.EXPERIENCE_YEARS or self == STATISTICS_KEY.EXPERIENCE_MONTHS:
            return DEFAULT_VALUE.INT_EXPERIENCE
