...
def plot_node_numbers_statistics(solution_graph: SolutionGraph, path: str = DEFAULT_PATH_FOR_PLOTS,
    ...
    plot_and_save_freq_chart(canon_trees_statistics_df, title='Vertices number for canon trees', path=path, column=column,
                             labels=labels, plot_name='vertices_number_for_canon_trees', format=format, auto_open=auto_open,
                             x_category_order=x_category_order)
    ...
    plot_and_save_freq_chart(anon_trees_statistics_df, title='Vertices number for anon trees', path=path, column=column,
                             labels=labels, plot_name='vertices_number_for_anon_trees', format=format, auto_open=auto_open,
                             x_category_order=x_category_order)
