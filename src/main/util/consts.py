...
EXTENSION_TO_LANGUAGE_DICT = {
    EXTENSION.PY: LANGUAGE.PYTHON.value,
    EXTENSION.JAVA: LANGUAGE.JAVA.value,
    EXTENSION.KT: LANGUAGE.KOTLIN.value,
    EXTENSION.CPP: LANGUAGE.CPP.value,
    EXTENSION.EMPTY: LANGUAGE.NOT_DEFINED.value
}
